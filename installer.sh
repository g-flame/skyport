#!/bin/bash
#links
PANEL="https://github.com/Thavanish/Skypoetpanelfork.git"
DAEMON="https://github.com/privt00/skyportd.git"
SEED="https://raw.githubusercontent.com/Thavanish/fabric-skyport-image/refs/heads/main/seed.js"
#colours
Blue='\033[0;34m'
White='\033[0;37m'
Green='\033[0;32m'
...
panel() {
    cd /etc
    git clone https://github.com/Thavanish/Skypoetpanelfork.git
    mv Skypoetpanelfork skyport
    cd skyport 
    cd exec
    rm seed.js
    wget https://raw.githubusercontent.com/Thavanish/fabric-skyport-image/refs/heads/main/seed.js
    cd ..
    npm install 
    npm run seed
    npm run createUser
...
daemon() {
    cd /etc
    git clone https://github.com/privt00/skyportd.git
    cd skyportd
    npm install
